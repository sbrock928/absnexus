...
DEAL_A_MAPPINGS = [
    ...
    ("a_note_rate", "Sheet 1", "J", 231, "Class A Note Rate"),
    ("a_note_balance", "Sheet 1", "J", 225, "Class A Note Balance (prior)"),
    ("b_note_rate", "Sheet 1", "J", 249, "Class B Note Rate"),
    ("b_note_balance", "Sheet 1", "J", 243, "Class B Note Balance (prior)"),
    ("c_note_rate", "Sheet 1", "J", 267, "Class C Note Rate"),
    ("c_note_balance", "Sheet 1", "J", 261, "Class C Note Balance (prior)"),
    ("d_note_rate", "Sheet 1", "J", 285, "Class D Note Rate"),
    ("d_note_balance", "Sheet 1", "J", 279, "Class D Note Balance (prior)"),
]
...
DEAL_A_DIST_NODES = [
    ...
    ("class_b_int_calc", "Class B Interest (calc)", "calculation",
     "b_note_balance * b_note_rate / 12", None, 300, 400),
    ("class_c_int_calc", "Class C Interest (calc)", "calculation",
     "c_note_balance * c_note_rate / 12", None, 500, 400),
    ("class_d_int_calc", "Class D Interest (calc)", "calculation",
     "d_note_balance * d_note_rate / 12", None, 700, 400),

    # Row 5: remaining after interest
    ("remaining_after_int", "Remaining After Interest", "calculation",
     "MAX(net_available - class_a_int_calc - class_b_int_calc - class_c_int_calc - class_d_int_calc, 0)",
     None, 400, 520),
    ...
    ("class_a_int_pmt", "Class A Interest Pmt", "distribution",
     "MIN(net_available, class_a_int_calc)", "INT_PMT_A", 175, 640),
    ("class_b_int_pmt", "Class B Interest Pmt", "distribution",
     "MIN(MAX(net_available - class_a_int_calc, 0), class_b_int_calc)",
     "INT_PMT_B", 300, 640),
    ...
    ("class_d_int_pmt", "Class D Interest Pmt", "distribution",
     "MIN(MAX(net_available - class_a_int_calc - class_b_int_calc - class_c_int_calc, 0), class_d_int_calc)",
     "INT_PMT_D", 550, 640),

    # Row 7: principal distributions — sequential A→B→C→D
    ("class_a_prin_pmt", "Class A Principal Pmt", "distribution",
     "MIN(remaining_after_int, a_note_balance)", "PRIN_PMT_A", 100, 760),
    ("class_b_prin_pmt", "Class B Principal Pmt", "distribution",
     "MIN(MAX(remaining_after_int - class_a_prin_pmt, 0), b_note_balance)",
     "PRIN_PMT_B", 300, 760),
    ("class_c_prin_pmt", "Class C Principal Pmt", "distribution",
     "MIN(MAX(remaining_after_int - class_a_prin_pmt - class_b_prin_pmt, 0), c_note_balance)",
     "PRIN_PMT_C", 500, 760),
    ("class_d_prin_pmt", "Class D Principal Pmt", "distribution",
     "MIN(MAX(remaining_after_int - class_a_prin_pmt - class_b_prin_pmt - class_c_prin_pmt, 0), d_note_balance)",
     "PRIN_PMT_D", 700, 760),
]
...
DEAL_A_EDGES = [
    ...
    ("class_a_int_calc", "class_d_int_pmt"),
    ("class_b_int_calc", "class_d_int_pmt"),
    ("class_c_int_calc", "class_d_int_pmt"),
...
DEAL_B_MAPPINGS = [
    ...
    ("a_note_rate", "Sheet 1", "F", 62, "Class A Note Rate"),
    ("b_note_rate", "Sheet 1", "F", 63, "Class B Note Rate"),
    ("c_note_rate", "Sheet 1", "F", 64, "Class C Note Rate"),
    ("d_note_rate", "Sheet 1", "F", 65, "Class D Note Rate"),
    ("e_note_rate", "Sheet 1", "F", 66, "Class E Note Rate"),
    ("f_note_rate", "Sheet 1", "F", 67, "Class F Note Rate"),
    ("a_note_balance", "Sheet 1", "E", 46, "Class A Begin Balance"),
    ("b_note_balance", "Sheet 1", "F", 46, "Class B Begin Balance"),
    ("c_note_balance", "Sheet 1", "G", 46, "Class C Begin Balance"),
    ("d_note_balance", "Sheet 1", "H", 46, "Class D Begin Balance"),
    ("e_note_balance", "Sheet 1", "I", 46, "Class E Begin Balance"),
    ("f_note_balance", "Sheet 1", "J", 46, "Class F Begin Balance"),
]
...
DEAL_C_MAPPINGS = [
    ...
    ("a_note_rate", "Sheet1", "F", 61, "Class A Note Rate"),
    ("b_note_rate", "Sheet1", "F", 62, "Class B Note Rate"),
    ("c_note_rate", "Sheet1", "F", 63, "Class C Note Rate"),
    ("d_note_rate", "Sheet1", "F", 64, "Class D Note Rate"),
    ("e_note_rate", "Sheet1", "F", 65, "Class E Note Rate"),
    ("f_note_rate", "Sheet1", "F", 66, "Class F Note Rate"),
    ("a_note_balance", "Sheet1", "D", 45, "Class A Begin Balance"),
    ("b_note_balance", "Sheet1", "E", 45, "Class B Begin Balance"),
    ("c_note_balance", "Sheet1", "F", 45, "Class C Begin Balance"),
    ("d_note_balance", "Sheet1", "G", 45, "Class D Begin Balance"),
    ("e_note_balance", "Sheet1", "H", 45, "Class E Begin Balance"),
    ("f_note_balance", "Sheet1", "I", 45, "Class F Begin Balance"),
]
...
def _build_6class_dag():
    ...
    dist_nodes = [
        ...
        ("class_a_int_calc", "Class A Interest (calc)", "calculation",
         "a_note_balance * a_note_rate / 12", None, 50, 400),
        ("class_b_int_calc", "Class B Interest (calc)", "calculation",
         "b_note_balance * b_note_rate / 12", None, 200, 400),
        ("class_c_int_calc", "Class C Interest (calc)", "calculation",
         "c_note_balance * c_note_rate / 12", None, 350, 400),
        ("class_d_int_calc", "Class D Interest (calc)", "calculation",
         "d_note_balance * d_note_rate / 12", None, 500, 400),
        ("class_e_int_calc", "Class E Interest (calc)", "calculation",
         "e_note_balance * e_note_rate / 12", None, 650, 400),
        ("class_f_int_calc", "Class F Interest (calc)", "calculation",
         "f_note_balance * f_note_rate / 12", None, 800, 400),

        # Remaining after all interest
        ("remaining_after_int", "Remaining After Interest", "calculation",
         "MAX(net_available - class_a_int_calc - class_b_int_calc - class_c_int_calc - class_d_int_calc - class_e_int_calc - class_f_int_calc, 0)",
         None, 400, 520),
        ...
        ("svc_fee_pmt", "Servicing Fee Pmt", "distribution",
         "svc_fee_tape", "SVC_FEE", 50, 640),
        ("class_a_int_pmt", "Class A Interest Pmt", "distribution",
         "MIN(net_available, class_a_int_calc)", "INT_PMT_A", 150, 640),
        ("class_b_int_pmt", "Class B Interest Pmt", "distribution",
         "MIN(MAX(net_available - class_a_int_calc, 0), class_b_int_calc)",
         "INT_PMT_B", 270, 640),
        ("class_c_int_pmt", "Class C Interest Pmt", "distribution",
        ...
        ("class_e_int_pmt", "Class E Interest Pmt", "distribution",
         "MIN(MAX(net_available - class_a_int_calc - class_b_int_calc - class_c_int_calc - class_d_int_calc, 0), class_e_int_calc)",
         "INT_PMT_E", 630, 640),
        ("class_f_int_pmt", "Class F Interest Pmt", "distribution",
         "MIN(MAX(net_available - class_a_int_calc - class_b_int_calc - class_c_int_calc - class_d_int_calc - class_e_int_calc, 0), class_f_int_calc)",
         "INT_PMT_F", 750, 640),
    ...
    validation_nodes = [
        ("oc_amount_check", "OC Amount Check", "validation",
         "ABS(cur_pool_bal - a_note_balance - b_note_balance - c_note_balance - d_note_balance - e_note_balance - f_note_balance)",
    ...
    edges = [
        ...
        ("class_b_int_calc", "class_d_int_pmt"),
        ("class_c_int_calc", "class_d_int_pmt"),
        ("class_a_int_calc", "class_e_int_pmt"),
        ("class_b_int_calc", "class_e_int_pmt"),
        ("class_c_int_calc", "class_e_int_pmt"),
        ("class_d_int_calc", "class_e_int_pmt"),
        ("class_a_int_calc", "class_f_int_pmt"),
        ("class_b_int_calc", "class_f_int_pmt"),
        ("class_c_int_calc", "class_f_int_pmt"),
